...
sub printComment{
	...
	if($post_order ne "instructor_post"){
		...
		$text_to_print	.= "<tr><td><label><div class=\'course-forum-post-header\'>
							<h5 class=\'course-forum-post-byline\'>
							<table width=\'100\%\'  style=\'font-size:14\'><tbody>
							<tr><td style=\'text-align:left\'>1) Yes, the instructor replies to this student post &nbsp;&nbsp;<input type=\'checkbox\' onclick=\'enableCombo(this,$post_order)\' value=\'$post_order\' name=\'$post_order\'> </td>	<td><a href=\'\#ipost\'>Go to Instructor's post</a></td></tr>
