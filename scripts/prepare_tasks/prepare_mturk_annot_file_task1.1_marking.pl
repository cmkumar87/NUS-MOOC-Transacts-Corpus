...
if ($corpus eq 'pilot'){
    ...
    # @courses = ('reasonandpersuasion-001');
    #@courses = ('randomness-001');
     @courses = ('classicalcomp-002');
    # RUN classical-comp-001,002, reason-001,02 
   ...
   # @courses = ('howthingswork1-002');
    ...
    # @courses=('analyze-001');
    #@courses = ('virtualassessment-001');
    #    @courses=('reactive-001');
...
my $forumidsquery	= "select id,courseid,forumname from forum ";
 $forumidsquery		= Model::appendListtoQuery($forumidsquery,\@courses, 'courseid ','where ');
  $forumidsquery	.= "and forumname in('Lecture','Exam','Homework','General','Project','Discussion','PeerA')";
...
sub printComment{
	...
	if($post_order ne "instructor_post"){
		...
		$text_to_print	.= "<tr><td><label><div class=\'course-forum-post-header\'>
							<h5 class=\'course-forum-post-byline\'>
							<table width=\'100\%\'  style=\'font-size:14\'><tbody>
							<tr><td style=\'text-align:left\'>Yes, the instructor's post <b>clearly</b> refers to the content in this student post &nbsp;&nbsp;<input type=\'checkbox\' onclick=\'enableCombo(this,$post_order)\' value=\'$post_order\' name=\'$post_order\'> </td>	<td><a href=\'\#ipost\'>Go to Instructor's post</a></td></tr>
							...
							<option value=\'feedbackreq\'>Feedback Request</option> 
...
sub printPost{
	...
	if($post_order ne "instructor_post"){
		...
		$text_to_print	.= "<tr><td><label><div class=\'course-forum-post-header\'><h5 class=\'course-forum-post-byline\'>
							<table width=\'100\%\'  style=\'font-size:14\'><tbody>
							<tr><td style=\'text-align:left\'>Yes, the instructor's post <b>clearly</b> refers to the content in this student post &nbsp;&nbsp;<input type=\'checkbox\' onclick=\'enableCombo(this,$post_order)\' value=\'$post_order\' name=\'$post_order\'></td>
